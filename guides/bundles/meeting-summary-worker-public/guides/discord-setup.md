...
With Discord configured correctly, OpenClaw can do things that were blocked on chat surface in this environment:
...
- access to edit `<workspace_root>/.env`
- access to edit `<workspace_root>/openclaw.json`
- a Discord account
...
- **one private Discord server** for the assistant / OpenClaw work
...
- verify the manager loads `templates/RUNBOOK.md`
