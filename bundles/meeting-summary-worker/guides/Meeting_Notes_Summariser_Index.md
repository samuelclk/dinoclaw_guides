...
- Local: `workspace/guides/Cheat_Sheet_Meeting_Notes_Summariser.md`
- GitHub: <https://github.com/stakesaurus-lido/lidoclaw/blob/main/workspace/guides/Cheat_Sheet_Meeting_Notes_Summariser.md>

### 2. Quickstart
Shortest path to replicate the setup.
Use this if you want the minimum viable system.

- Local: `workspace/guides/Quickstart_High_Signal_Meeting_Notes_Summariser.md`
- GitHub: <https://github.com/stakesaurus-lido/lidoclaw/blob/main/workspace/guides/Quickstart_High_Signal_Meeting_Notes_Summariser.md>

### 3. Operator Guide
Full build methodology and replication logic.
Use this if you want the whole system, not just the minimum steps.

- Local: `workspace/guides/Operator_Guide_Building_a_High_Signal_Meeting_Notes_Summariser_in_OpenClaw.md`
- GitHub: <https://github.com/stakesaurus-lido/lidoclaw/blob/main/workspace/guides/Operator_Guide_Building_a_High_Signal_Meeting_Notes_Summariser_in_OpenClaw.md>

### 4. Trigger Runbook
How to actually trigger the summariser in the current interim workflow.
Use this for day-to-day operation.

- Local: `workspace/guides/Runbook_Triggering_the_Meeting_Notes_Summariser.md`
- GitHub: <https://github.com/stakesaurus-lido/lidoclaw/blob/main/workspace/guides/Runbook_Triggering_the_Meeting_Notes_Summariser.md>
...
- Local: `workspace/guides/Discord_Setup_for_Persistent_Thread_Bound_Subagents_on_OpenClaw.md`
- GitHub: <https://github.com/stakesaurus-lido/lidoclaw/blob/main/workspace/guides/Discord_Setup_for_Persistent_Thread_Bound_Subagents_on_OpenClaw.md>
...
- `workspace/meeting-summary-style-training/io-contract.md`
...
At the moment:
- Telegram works well for manual triggering
