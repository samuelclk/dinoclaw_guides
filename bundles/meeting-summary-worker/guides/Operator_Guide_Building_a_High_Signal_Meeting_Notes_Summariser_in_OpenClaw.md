...
```text
workspace/meeting-summary-style-training/
  README.md
  source/
  target/
  negative/
...
- read source files
- produce Samuel-style summaries
...
- Telegram topic here did **not** support the thread-binding behavior needed for persistent sub-agent / ACP specialist sessions
- Discord docs explicitly support thread bindings and persistent ACP channel bindings

## Operational conclusion
- **Telegram** can still drive the workflow manually
...
- `workspace/guides/Discord_Setup_for_Persistent_Thread_Bound_Subagents_on_OpenClaw.md`
...
- `workspace/meeting-summary-style-training/README.md`
